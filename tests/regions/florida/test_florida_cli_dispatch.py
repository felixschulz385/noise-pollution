...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["florida", "data", "barrier-protection", "build"],
        ["florida", "data", "barrier-protection", "build", "--budget-m", "500", "--buffer-m", "400"],
        ...
        ["florida", "data", "staff", "fetch", "--subsource", "teacher-salary", "--year", "2025"],
        ["florida", "data", "staff", "fetch", "--subsource", "out-of-field", "--year", "2025", "--from-file", "a.xlsx"],
        ["florida", "data", "staff", "preprocess"],
        ["florida", "data", "staff", "assemble"],
        ["florida", "data", "neighbourhood", "fetch"],
        ["florida", "data", "neighbourhood", "fetch", "--subsource", "acs", "--year", "2022"],
        ["florida", "data", "neighbourhood", "preprocess"],
        ["florida", "data", "neighbourhood", "assemble"],
